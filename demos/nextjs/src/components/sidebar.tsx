...
export default function Sidebar() {
	...
	return (
		<aside
			className={cn(
				'dark:bg-dark fixed top-16 right-auto bottom-0 left-0 z-20 flex w-78 -translate-x-full flex-col justify-between overflow-y-auto border-t border-slate-200/80 bg-white px-6 pb-6 transition-transform sm:px-8 md:px-10 lg:left-[max(0px,calc(50%-46rem))] lg:translate-x-0 dark:border-slate-800',
				{
